...
<footer class="footer__section footer__bg">
  <div class="container-fluid">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="footer__widget">
            ...
            <div class="footer__widget--inner">
              ...
              <p class="footer__widget--desc">Website kinh doanh các sản phẩm thiết bị âm thanh<br> LushShop</p>
    ...
    <div class="footer__bottom d-flex justify-content-between align-items-center">
      <p class="copyright__content  m-0">Copyright © 2022 <a class="copyright__content--link" href="<%=request.getContextPath()%>/home">LushShop</a> . All Rights Reserved.Design By Lush</p>
